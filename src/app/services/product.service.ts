...
export class ProductService {
    ...
    addNewProduct(productForm: any): Observable<any> {
        return this.http.post<any>('http://34.41.92.132:5000/api/Product', productForm, {withCredentials: true})
    }

    deleteProduct(productID: number): Observable<any> {
        return this.http.delete<any>(`http://34.41.92.132:5000/api/Product/${productID}`, {withCredentials: true})
    }
